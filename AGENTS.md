...
- Image procedure name: `plug-in-lanczos-scale`.
- Layer procedure name: `plug-in-lanczos-scale-layer`.
...
- Unsupported for now: indexed drawables.
...
- Resampling: custom separable windowed-sinc filters plus experimental EWA Jinc paths with premultiplied-alpha filtering.
...
- Choices: `Lanczos 3`, `Lanczos 2`, `Kaiser-Sinc 3`, `Kaiser-Sinc 4`, `EWA Jinc Sharp`, `EWA Jinc`, `EWA Jinc Smooth` in a combo box
- OK button: `_Scale`
